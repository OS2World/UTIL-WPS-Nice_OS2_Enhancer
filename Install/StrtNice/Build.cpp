...
VOID main( VOID )
{
 ...
 // Имена файлов.
 CHAR CPP_Name[] = "StrtNice.cpp";
 CHAR DEF_Name[] = "StrtNice.def";
 CHAR LIB_Name[] = "..\\..\\Nice-os2\\Shared\\DosCalls\\Doscalls.lib";

 CHAR OBJ_Name[] = "StrtNice.obj";
 CHAR RC_Name[] =  "StrtNice.rc";
 CHAR TGT_Name[] = "StrtNice.exe ";
 CHAR RES_Name[] = "StrtNice.res";
