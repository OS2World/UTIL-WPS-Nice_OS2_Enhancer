...
VOID Drawing_Exceptions_CreatePage (VOID)
{
  // Указатель на страницу.
  PPAGE Page = Enhancer.Pages.Drawing_exceptions;

  // Создаем страницу.
  CHAR Page_class_name[] = "Drawing_Exceptions_WndClass";
  WinRegisterClass (Enhancer.Application, Page_class_name, (PFNWP) Drawing_Exceptions_WndProc, 0, 0);
...

  {
    ...
    Box_brick.hwnd = WinCreateWindow (Page->Window, WC_STATIC, NULL, SS_TEXT, LTM_X, LTM_Y, LTM_CX, LTM_CY, Page->Window, HWND_TOP, Drawing_Exceptions.Settings.Container_BorderDraw_ID, NULL, NULL);
...

    {
      ...
      List_brick.hwnd = WinCreateWindow (Box_brick.hwnd, WC_LISTBOX, NULL, 0, LTM_X, LTM_Y, LTM_CX, LTM_CY, Page->Window, HWND_TOP, Drawing_Exceptions.Settings.List_BorderDraw_ID, NULL, NULL);
...

      {
        ...
        Button_brick.hwnd = WinCreateWindow (AddRemove_brick.hwnd, WC_BUTTON, NULL, BS_PUSHBUTTON, LTM_X, LTM_Y, LTM_CX, LTM_CY, Page->Window, HWND_TOP, Drawing_Exceptions.Settings.Add_button_BorderDraw_ID, NULL, NULL);
        ...
        Button_brick.hwnd = WinCreateWindow (AddRemove_brick.hwnd, WC_BUTTON, NULL, BS_PUSHBUTTON, LTM_X, LTM_Y, LTM_CX, LTM_CY, Page->Window, HWND_TOP, Drawing_Exceptions.Settings.Remove_button_BorderDraw_ID, NULL, NULL);
        Button_brick.prpWidthInParent = LTM_BUTTON_WIDTH; Button_brick.prpHeightInParent = LTM_BUTTON_HEIGHT;
...

    {
      ...
      if (Code_page == RUSSIAN) WinSetWindowText (Caption_brick.hwnd, StrConst_RU_Pages_Drawing_exceptions_BorderDraw);
      else WinSetWindowText (Caption_brick.hwnd, StrConst_EN_Pages_Drawing_exceptions_BorderDraw);
  ...
  {
    LTBRICK Box_brick; LitPrepareBrick (&Box_brick);
    Box_brick.hwnd = WinCreateWindow (Page->Window, WC_STATIC, NULL, SS_TEXT, LTM_X, LTM_Y, LTM_CX, LTM_CY, Page->Window, HWND_TOP, Drawing_Exceptions.Settings.Container_Disable_ID, NULL, NULL);
    Box_brick.prpWidthInParent = LTM_FULL_WIDTH; Box_brick.prpHeightInParent = XC_BOX_BRICK_HEIGHT; Box_brick.prpGap = XC_BOX_BRICK_GAP;
    LitJoinBrick (&(Page->Layout), &Box_brick); 
    ...
    {
      LTBRICK List_brick; LitPrepareBrick (&List_brick);
      List_brick.hwnd = WinCreateWindow (Box_brick.hwnd, WC_LISTBOX, NULL, 0, LTM_X, LTM_Y, LTM_CX, LTM_CY, Page->Window, HWND_TOP, Drawing_Exceptions.Settings.List_Disable_ID, NULL, NULL);
      List_brick.prpWidthInParent = XC_LST_BRICK_WIDTH; List_brick.prpHeightInParent = XC_LST_BRICK_HEIGHT;
      LitJoinBrick (&(Page->Layout), &List_brick);
...

      {
        ...
        LTBRICK Button_brick; LitPrepareBrick (&Button_brick);
        Button_brick.hwnd = WinCreateWindow (AddRemove_brick.hwnd, WC_BUTTON, NULL, BS_PUSHBUTTON, LTM_X, LTM_Y, LTM_CX, LTM_CY, Page->Window, HWND_TOP, Drawing_Exceptions.Settings.Add_button_Disable_ID, NULL, NULL);
        Button_brick.prpWidthInParent = LTM_BUTTON_WIDTH; Button_brick.prpHeightInParent = LTM_BUTTON_HEIGHT;
        if (Code_page == RUSSIAN) WinSetWindowText (Button_brick.hwnd, StrConst_RU_Buttons_Add);
        else WinSetWindowText (Button_brick.hwnd, StrConst_EN_Buttons_Add);
        LitJoinBrick (&(Page->Layout), &Button_brick); 
        ...
        LitPrepareBrick (&Button_brick);
        Button_brick.hwnd = WinCreateWindow (AddRemove_brick.hwnd, WC_BUTTON, NULL, BS_PUSHBUTTON, LTM_X, LTM_Y, LTM_CX, LTM_CY, Page->Window, HWND_TOP, Drawing_Exceptions.Settings.Remove_button_Disable_ID, NULL, NULL);
        Button_brick.prpWidthInParent = LTM_BUTTON_WIDTH; Button_brick.prpHeightInParent = LTM_BUTTON_HEIGHT;
        if (Code_page == RUSSIAN) WinSetWindowText (Button_brick.hwnd, StrConst_RU_Buttons_Remove);
        else WinSetWindowText (Button_brick.hwnd, StrConst_EN_Buttons_Remove);
        LitJoinBrick (&(Page->Layout), &Button_brick); 
...

    {
      ...
      Caption_brick.prpWidthInParent = LTM_COMMON_WIDTH; Caption_brick.prpHeightInParent = LTM_COMMON_HEIGHT;
      SetCommonEnhancerColors (Caption_brick.hwnd);
      if (Code_page == RUSSIAN) WinSetWindowText (Caption_brick.hwnd, StrConst_RU_Pages_Drawing_exceptions_Disable);
      else WinSetWindowText (Caption_brick.hwnd, StrConst_EN_Pages_Drawing_exceptions_Disable);
      LitJoinBrick (&(Page->Layout), &Caption_brick); 
  ...
  if (Code_page == RUSSIAN)
   CreatePromptText (Page, StrConst_RU_Pages_Drawing_exceptions_Prompt);
  else
   CreatePromptText (Page, StrConst_EN_Pages_Drawing_exceptions_Prompt);
