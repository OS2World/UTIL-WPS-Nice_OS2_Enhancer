...
VOID Connector_NiceReadSettings( BYTE Update_windows = 0 )
{
 // Посылаем сообщение.
 WinPostMsg( WinWindowFromID( Enhancer.Remote_window, FID_CLIENT ), SM_RECEIVE_SETTINGS, (MPARAM) Update_windows, 0 );
