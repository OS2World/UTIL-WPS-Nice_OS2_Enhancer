...
#define USB_NOT_INIT                    0x7000
#define USB_ERROR_NO_MORE_NOTIFICATIONS 0x7001
#define USB_ERROR_OUTOF_RESOURCES       0x7002
#define USB_ERROR_INVALID_ENDPOINT      0x7003
#define USB_ERROR_LESSTRANSFERED        0x7004

/* IORB status codes */
#define USB_IORB_DONE                   0x0000
#define USB_IORB_WORKING                0x8001
#define USB_IORB_CANCELED               0x8002
#define USB_IORB_DEVICE_REMOVED         0x8003
#define USB_IORB_STALLED                0x8004
#define USB_IORB_FAILED                 0x8005
