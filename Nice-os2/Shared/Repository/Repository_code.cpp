...
VOID Repository_SetRepository (VOID)
{
  ...
  Repository.Items[I].Application = APP_NICE_ENHANCER;
  Repository.Items[I].Purpose = DO_IMPROVE_WORKPLACE;
  strcpy (Repository.Items[I].Exe_name_1, "Nice-os2.exe");

  Repository_next (&I); Repository_clear (&Repository.Items[I]);
  Repository.Items[I].Application = APP_NICE_ENHANCER_SHELL;
  strcpy (Repository.Items[I].Exe_name_1, "Nice-aos.exe");
  ...
  Repository_next (&I); Repository_clear (&Repository.Items[I]);
  Repository.Items[I].Application = APP_OTTER;
  Repository.Items[I].Purpose = DO_BROWSE_WEB_PAGES;
  Repository.Items[I].Action = SHOW_WEB_BROWSER;
  strcpy (Repository.Items[I].Exe_name_1, "Otter.exe");
  strcpy (Repository.Items[I].Object_INI_setting_name, "Otter object");
  strcpy (Repository.Items[I].Path_INI_setting_name, "Otter path");
