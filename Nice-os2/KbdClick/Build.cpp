...
VOID main( VOID )
{
 ...
 // Имена файлов.
 CHAR CPP_Name[] = "Keyboard.cpp";
 CHAR DEF_Name[] = "Keyboard.def";

 CHAR OBJ_Name[] = "Keyboard.obj";
 CHAR RC_Name[] =  "Keyboard.rc";
 CHAR TGT_Name[] = "Keyboard.exe ";
 CHAR RES_Name[] = "Keyboard.res";
