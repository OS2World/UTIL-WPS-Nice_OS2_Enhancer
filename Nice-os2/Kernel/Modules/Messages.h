...
#define SM_ARRANGE_NW_DIALER          (WM_USER + 145  )
#define SM_ARRANGE_XWP_PAGER          (WM_USER + 146  )
#define SM_ARRANGE_IPF_HELP           (WM_USER + 147  )
#define SM_ARRANGE_WIN_LIST           (WM_USER + 148  )
