...
// ************************************************************************************
// * This code is intended for enhancement software only. In your own OS/2 programs   *
// * you must use the WinGetKeyState function with virtual key constants also known   *
// * as "VK_*" or V-Keys. They makes your program portable and works faster.          *
// ************************************************************************************

// ************************************************************************************
// * Эта часть программы предназначена для использования только в расширителях. Если  *
// * вы пишете свою программу, вы должны использовать метод WinGetKeyState и значения *
// * вида "VK_*" или V-коды, которые делают программу переносимой и работают быстрее. *
// ************************************************************************************
